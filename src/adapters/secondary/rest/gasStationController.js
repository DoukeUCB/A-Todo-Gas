...
// Exporta una función para crear el router con el servicio ya inicializado
function createGasStationRouter(gasStationService) {
...
module.exports = { createGasStationRouter, GasStationService };
